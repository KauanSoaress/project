...
from utils.user_utils.user_defs import get_user, get_user_by_id, delete_user, edit_user, post_user
...
class TestUserDefs(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.app.config['MONGO_DB'].__getitem__.return_value = self.mock_user_collection
    ...
    def test_get_user_by_id(self, mock_verify_id):
        ...
        mock_find_one.assert_called_once_with({"_id": ObjectId('66a3d3e92646ece2a8c4e49c')}, {"_id": 0, "name": 1, "age": 1})
    ...
    def test_post_user(self, mock_verify_age, mock_verify_name):
        ...
        with self.app.test_request_context(json={"name": "User 1", "age": 21}):
            ...
            mock_insert.assert_called_once_with({"name": "User 1", "age": 21, '_id': '66a3d3e92646ece2a8c4e49c'})
    ...
    @patch('utils.user_utils.user_defs.verify_age')
    @patch('utils.user_utils.user_defs.verify_id')
    def test_edit_user(self, mock_verify_id, mock_verify_age, mock_verify_name):
        ...
        with self.app.test_request_context(json={"name": "User 1", "age": 21}):
            ...
            mock_update_one.assert_called_once_with({"_id": ObjectId('66a3d3e92646ece2a8c4e49c')}, {"$set": {"name": "User 1", "age": 21}})
