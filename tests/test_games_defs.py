...
from utils.games_utils.games_defs import get_games, \
    post_games, get_game_by_name, delete_game, edit_game
...
class TestGamesDefs(unittest.TestCase):
    ...
    def test_get_game_by_name_sucess(self):
        ...
        mock_find_one.return_value = {
            "name": "Game",
            "year": 2021,
            "user_id": "66a3d3e92646ece2a8c4e49c"
            }
